...
image::/Assets/Images/Cserich_Philipp/Design-Layouts.png[layouts,title="Design Layout footnote:[Reimagined picture from Refactoring UI - Chapter (Start with a feature, not a layout)]"]
