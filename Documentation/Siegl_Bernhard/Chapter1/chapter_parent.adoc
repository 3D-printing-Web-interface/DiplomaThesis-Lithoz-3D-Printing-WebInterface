...
image::/Assets/Images/Siegl_Bernhard/MQTT.jpg[MQTT Introduction]
...
image::/Assets/Images/Siegl_Bernhard/mqtt-publish-subscribe.png[Publish/Broker Architecture ,70%,70%]
